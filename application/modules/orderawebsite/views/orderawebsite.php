          ...
          <div class="register-card-body">
            <div class="logo-main">
              ...
              <div class="napacusa_name">
                <label>Order a Website Form</label>
              </div>
            </div>
                      ...
                      <?php if (!DONATION) : ?>
                        <div class="col-md-6 mb-3">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" name="Payment_For" value="Order a Website" class="form-control form-control-lg required" id="Payment_For" placeholder="Enter payment details" aria-describedby="Payment_ForPrepend">
                            <div class="invalid-tooltip">
                  ...
                  <div class="form-row">
                    <div class="col-md-6 mb-3">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" name="Company_Name" class="form-control form-control-lg required" id="Company_Name" placeholder="Enter company name">
                        <div class="invalid-tooltip">
                    ...
                    <div class="col-md-6 mb-3">
                      ...
                      <div class="input-group">
                        ...
                        <input type="tel" name="Website_Link" class="form-control form-control-lg required" id="Website_Link" placeholder="Enter website link">
                        <div class="invalid-tooltip">
                  ...
                  <div class="form-row">
                    <div class="col-md-12 mb-3">
                      ...
                      <div class="input-group">
                        ...
                        <input type="email" name="Email" class="form-control form-control-lg required" id="Email" placeholder="Enter your email">
                        <div class="invalid-tooltip">
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      ...
      function getajax() {
        ...
        $.ajax({
          type: "POST",
          url: "<?php echo base_url('orderawebsite/ajax_payment'); ?>",
          data: formdata,
      ...
      <?php if ($gateways['paypal']) : ?>
        paypal.Button.render({
          ...
          payment: function(data, actions) {
            ...
            var CREATE_URL = "<?php echo base_url('orderawebsite/ajax_payment/direct'); ?>";
          ...
          onAuthorize: function(data, actions) {
            ...
            var EXECUTE_URL = "<?php echo base_url('orderawebsite/ajax_payment/return'); ?>";
