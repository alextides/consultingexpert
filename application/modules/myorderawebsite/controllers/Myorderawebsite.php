...
class Myorderawebsite extends MY_Controller
{


   public function index()
   {
      $data['title'] = 'Order a Website';
      $data['users'] = $this->getusers();
      $this->load_page2('myorderawebsite', $data, 'moaw_footer.php', 'moaw_header.php');
   }
   ...
   public function getmyorderawebsite()
   {
      ...
      $oaw = $this->db
         ...
         ->where('ci_orderawebsite.orderawebsite_status', '1')
         ->where('ci_orderawebsite.fk_user_id', $fk_user_id)
