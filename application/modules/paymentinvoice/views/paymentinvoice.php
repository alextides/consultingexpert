...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url(); ?>payment-assets/css/fa-solid.min.css">
  <link rel="stylesheet" href="<?php echo base_url(); ?>payment-assets/css/fontawesome.min.css">
  <?php if ($gateways['authorize'] || $gateways['payeezy']) : ?>
    <link rel="stylesheet" href="<?php echo base_url(); ?>payment-assets/css/card.css">
  <?php endif; ?>
  <link rel="stylesheet" href="<?php echo base_url(); ?>payment-assets/css/square.css">
  <link rel="stylesheet" href="<?php echo base_url(); ?>payment-assets/css/style.css">
  <!-- page css -->
...
<body>
  <div>
    ...
    <section id="wrapper">
      <div class="login-register" style="position:relative;">
        <div class="register-box card" style="height:auto;width:900px;">
          <div class="register-card-body">
            <div class="logo-main">
              <img class="main_logo" src="<?= base_url("assets/images/main-logo-new.jpg") ?>" alt="Main Logo">
              <div class="napacusa_name">
                <label>Quote Payment Form</label>
              </div>
            </div>
              ...
              <fieldset>
                ...
                <div class="col-sm-12">
                  ...
                  <?php if (empty($payments)) : ?>
                    ...
                    <div class="form-row">
                      <div class="col-md-6 mb-3">
                        <label for="Amount">Website Quote</label>
                      ...
                      <?php if (!DONATION) : ?>
                        <div class="col-md-6 mb-3">
                          <label for="Amount">Agency Quote</label>
                          <div class="input-group">
                            <div class="input-group-prepend">
                  ...
                  <div class="form-row">
                    <div class="col-md-6 mb-3">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" name="First_Name" class="form-control form-control-lg required" id="First_Name" value="<?php echo $this->session->userdata('user_details')[0]['first_name'] ?>" readonly hidden>
                        <input type="text" name="Last_Name" class="form-control form-control-lg required" id="Last_Name" value="<?php echo $this->session->userdata('user_details')[0]['last_name'] ?>" readonly hidden>
                        <input type="email" name="Email" class="form-control form-control-lg required" id="Email" value="<?php echo $this->session->userdata('user_details')[0]['email'] ?>" readonly hidden>
                        <div class="invalid-tooltip">
                  ...
                  <?php if (TEST_EMAIL) { ?>
                    <!-- <div>hello</div> -->
                  <?php } else { ?>
                    <div class="form-row" <?php if ($gcount == 1) {
                                            echo 'hidden';
                                          } ?>>
                      <div class="col-sm-12">
  ...
  <?php endif; ?>
  <?php if ($gateways['square']) :
    $new_url = (TEST_MODE) ? "https://js.squareupsandbox.com/v2/paymentform" : "https://js.squareup.com/v2/paymentform";
  ?>
    <script src="<?php echo $new_url; ?>"></script>
  <?php endif; ?>
  <script type="text/javascript">
    $(document).ready(function() {
      ...
      <?php if (!empty($payments)) : ?>
        $('select[name="Payment_For"]').on('change', function() {
          ...
          if (amt == '') {
            ...
            $('#amounttooltip').show();
            setTimeout(function() {
              $('input[name="Amount"]').focus().select();
            }, 0);
      ...
      function getajax() {
        ...
        $.ajax({
          type: "POST",
          url: "<?php echo base_url('paymentinvoice/ajax_payment'); ?>",
          data: formdata,
      ...
      <?php if ($gateways['paypal']) : ?>
        paypal.Button.render({
          ...
          payment: function(data, actions) {
            ...
            var CREATE_URL = "<?php echo base_url('paymentinvoice/ajax_payment/direct'); ?>";
          ...
          onAuthorize: function(data, actions) {
            ...
            var EXECUTE_URL = "<?php echo base_url('paymentinvoice/ajax_payment/return'); ?>";
