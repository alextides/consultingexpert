<div class="container-fluid">
   <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-themecolor page-title-text">Technician List</h3>
        </div>
        <?php if($this->session->userdata('type') != 'admin'){  ?>
        <div class="col-md-7 align-self-center text-right center-container">
          <button type="button" class="btn btn-btn-mod add-technician" data-id="1"><i class="fa fa-plus-circle"></i> Create New Technician</button>
            ...
            <div class="card">
                <div class="card-body">
                   <div class="table-responsive">
                    <table id="technicianlist_datatable" class="table table-striped jambo_table bulk_action dt-responsive" style="width: 100% !important;">
                      <thead>
                          <tr>
                              <th>First Name</th>
                              <th>Last Name</th>
                              <th>Brand Establishment</th>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="addUserLabel">Add Technician</h5>
         ...
         <div class="modal-body">
            ...
            <div class="form-row">
               ...
               <div class="form-row">
                  ...
                  <div class="form-group col-md-6">
                     <label for="brand_e">Brand Establishment</label>
                     <select id="brand_e" name="brand_e" class="form-control">
                     </select>
                  </div>
               </div>
            <div class="form-row">
...
<div class="modal fade" id="editUser" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="addUserLabel">Edit Technician</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <form id="edit_technician_form" action="<?php echo base_url(); ?>technicianlist/update_user" method="post">
         <div class="modal-body">
            ...
            <div class="form-row">
               ...
               <div class="form-group col-md-6">
                  <label for="edit_assignment">Service Center</label>
                  <select id="edit_assignment" name="edit_assignment" class="form-control">
                  </select>
               </div>
               <!-- <div class="form-group col-md-6">
                  <label for="usertype">User Type</label>
               ...
               <div class="form-row">
                  ...
                  <div class="form-group col-md-6">
                     <label for="edit_brand_e">Brand Establishment</label>
                     <select id="edit_brand_e" name="edit_brand_e" class="form-control">
                     </select>
                  </div>
               </div>
            <div class="form-row">
...
<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyChx110grJVYdP-cahkZfBk7fn9okzkQ5M&libraries=places"></script>
<script>
var options = {
types: ['(cities)'],
...
new google.maps.places.Autocomplete(document.getElementById('edit_address'),options);
</script>
