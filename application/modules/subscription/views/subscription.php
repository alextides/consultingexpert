  ...
  <script type="text/javascript">
    $(document).ready(function() {
      ...
      function getajax() {
        ...
        $.ajax({
          type: "POST",
          url: "<?php echo base_url('subscription/ajax_payment'); ?>",
          data: formdata,
      ...
      <?php if ($gateways['paypal']) : ?>
        paypal.Button.render({
          ...
          payment: function(data, actions) {
            ...
            var CREATE_URL = "<?php echo base_url('subscription/ajax_payment/direct'); ?>";
          ...
          onAuthorize: function(data, actions) {
            ...
            var EXECUTE_URL = "<?php echo base_url('subscription/ajax_payment/return'); ?>";
